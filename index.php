...
<div id="welcome">
  ...
  <div id="slider">
      <div id="featured"> 
        ...
        <img class="slider" src="<?php bloginfo('template_url'); ?>/images/sliderclip2.jpeg"/>
        <img class="slider" src="<?php bloginfo('template_url'); ?>/images/sliderclip3.jpeg" />
        <img class="slider" src="<?php bloginfo('template_url'); ?>/images/sliderclip4.jpeg" />
